...
public class TPEntrega1 {
    ...
    static void tests(ArrayList<Vendedor> vendedores) {

        for (int i = 0; i < vendedores.size(); i++) {
            System.out.println("vendedor: " + vendedores.get(i).getNombre());   

            // getItemBebidas
            List<Bebida> bebidas = vendedores.get(i).getItemBebidas();

            System.out.println("    bebidas");
            for (Bebida bebida : bebidas)
                System.out.println("        " + bebida.getTamaño() + " " + bebida.getGraduacionAlcoholica());

            // getItemBebidasSinAlcohol
            List<Bebida> bebidasSinAlcohol = vendedores.get(i).getItemBebidasSinAlcohol();

            System.out.println("    bebidasSinAlcohol");
            for (Bebida bebida : bebidasSinAlcohol)
                System.out.println("        " + bebida.getTamaño() + " " + bebida.getGraduacionAlcoholica());

            // getItemComidas
            List<Plato> comidas = vendedores.get(i).getItemComidas();

            System.out.println("    comidas");
            for (Plato comida : comidas)
                System.out.println("        " + comida.getCalorias() + " aptoCeliaco:" +
                        comida.aptoCeliaco() + " aptoVegano:" +
                        comida.aptoVegano() + " peso:" +
                        comida.peso());

            // getItemComidasVeganas
            List<Plato> comidasVeganas = vendedores.get(i).getItemComidasVeganas();

            System.out.println("    comidasVeganas");
            for (Plato comida : comidasVeganas)
                System.out.println("        " + comida.getCalorias() + " aptoCeliaco:" +
                        comida.aptoCeliaco() + " aptoVegano:" +
                        comida.aptoVegano() + " peso:" +
                        comida.peso());
